...
class Backend:
    ...
    def __build_form_data(fields: Dict[str, Any]) -> FormData:
        ...
        field, None is omitted, a dict is sent as JSON, and other scalars are sent as
        text (aiohttp refuses ints, floats and bools).
        """
    ...
    async def __call_api(
        ...
        # Keys only: payloads carry prompts and inline media (voice-clone audio,
        # images), and this log is written to disk on a rented machine.
